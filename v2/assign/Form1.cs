...
namespace Assign
{
    ...
    public partial class Form1 : Form
    {
        ...
        public struct hole
        {
            public int start,size, id;


            public hole(int start, int size , int id ) 
            {
        ...
        public struct ForBestFit
        {

            public Form1.hole Hole;
            public int Size;
            public ForBestFit(int a, Form1.hole h)
            {
                this.Hole = h;
                this.Size = a;
        ...
        public static List<ForBestFit> sortedHoles_inSize = new List<ForBestFit>();

        public static  SortedDictionary<int, hole> sortedHoles_in_address =
           new SortedDictionary<int, hole>();

        public static SortedDictionary<int, hole> sortedHoles_in_address_exhausted =
          new SortedDictionary<int, hole>();
...
//        public static SortedDictionary<int, hole> sortedHoles_inSize =
//new SortedDictionary<int, hole>();


        public static Dictionary<int, int> allocted_holeId_processId_mapping =
        new Dictionary<int, int>();


        public struct NewProcessPair
        {
            public int P_start;
            public int p_size;


            public NewProcessPair(int first, int second)
            {
                this.P_start = first;
                this.p_size = second;
        ...
        public static Dictionary<int, NewProcessPair> allocated_processes_with_id =
new Dictionary<int, NewProcessPair>();
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            segment_number.Clear();
             holes_start.Clear();
             holes_size.Clear();
            sortedHoles_inSize.Clear();
            sortedHoles_in_address.Clear();
            ...
            for (int i = 0; i < Form1.holes_num; i++)
            {
                ...
                Form1.sortedHoles_in_address.Add(Form1.holes_start[i], new Form1.hole(Form1.holes_start[i], Form1.holes_size[i], i));
        ...
        private void add_process_Click(object sender, EventArgs e)
        {
            tableLayoutPanel1.Visible = false;
            tableLayoutPanel1.RowCount++;
            int uu = int.Parse(textBox1.Text);
            uu++;
            Label l1 = new Label();
            ...
            tableLayoutPanel1.Controls.SetChildIndex(t1, uu);
            TextBox t2 = new TextBox();
            tableLayoutPanel1.Controls.Add(t2, 2, tableLayoutPanel1.RowCount - 1);
            tableLayoutPanel1.Controls.SetChildIndex(t2, 2 * uu);
        ...
        public static Gant_chart gant;    // i needed to make it static to work ! 
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < holes_num; i++) { 
                ...
                sortedHoles_in_address.Add(holes_start[i] , new hole(holes_start[i] ,holes_size[i], i));
